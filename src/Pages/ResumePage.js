...
function ResumePage() {
    ...
    <div style={{ textAlign: 'center' }}>
        ...
        <CollapsibleContent buttonLabel="Minesweeper" content="Worked in a 2 person team to design and build an algorithm which navigates a maze to reach a goal, given information following the rules of minesweeper,
        Built in Python, utilized Resolution Inference, as well as storing and manipulating relevant clauses in a local database" />
        <CollapsibleContent buttonLabel="Toxicity Filter" content="Uses Naive Bayes Classifiers and Logistic Regression to perform preprocessing over comment text, 
        given various data (e.g. income, etc.) about commenter, and returns whether said comment is “toxic” given parameters.
        3 person team, used Tetrad to construct data network, Python to build algorithm" />
        <CollapsibleContent buttonLabel="Wordle Solver" content="Slightly altered version of Wordle which determines a hidden word between 2-14 letters long, with feedback given being edit distance and potential transformations
        ...
        <CollapsibleContent buttonLabel="Rhythm Monkey Heaven" content="Used Javascript and Adobe Animate to recreate a Rhythm Heaven Fever game, complete with score and different poses for each move Original Sprites drawn, 
        and dynamically synced music to different moves to limit hardcoding entire song." />
